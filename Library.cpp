...
void Library::append(string data)
{
...
void Library::prepend(string data)
{
    Node *tmp = new Node(data); //creates a new temporary Node
...
bool Library::search(string data)
{
...
bool Library::remove(string data)
{
...
void Library::display(ostream &os)
{
...
ostream &operator<<(ostream &os, Library &right)
    {
